...
// func CreatePost(db *pgxpool.Pool, req *gen.PostCreateData) error {
// 	queryUserInfo := `
// 		INSERT INTO post_info (user_id, login, password_hash, registered_at, changed_at, last_login_time)
// 		VALUES ($1, $2, $3, $4, $4, $4)`
// 	queryUserAdditional := `
